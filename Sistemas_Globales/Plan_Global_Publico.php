    ...
    if(isset($_POST['Btn_Buscar_Nivel']))
     ...
     // echo $Nivel;
      ...
      $query="SELECT * FROM objetivo ob, objetivos obs WHERE ob.ID_Objetivo=obs.Clave_Objetivo AND ob.ID_PG=1";
       ...
       $query="SELECT * FROM seccion_organizacion_contenidos WHERE ID_PG=1";
       ...
       $query="SELECT * FROM seccion_organizacion_contenidos s ,seccion_objetivo o WHERE s.ID_Unidad=o.ID_Unidad and s.ID_PG=1";
       ...
       $query="SELECT * FROM seccion_organizacion_contenidos s ,seccion_contenido o WHERE s.ID_Unidad=o.ID_Unidad and s.ID_PG=1";
